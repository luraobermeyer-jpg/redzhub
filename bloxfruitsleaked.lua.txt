...
BringEnemy = function()
	...
	local Fluent = loadstring(game:HttpGet("https://raw.githubusercontent.com/Jadelly/Ui/refs/heads/main/ZynLib"))()
	local Window = Fluent:CreateWindow({
		Title = "Matsune Hub Free Soucre",
		SubTitle = "nguuu",
		TabWidth = 160,
		Theme = "AMOLED",
		Acrylic = false,
	...
	local Tabs = {
		...
		Mirage = Window:AddTab({
			Title = "Mirage Island + V4"
		}),
		Drago = Window:AddTab({
			Title = "Drago Dojo Island"
		}),
...
local HalloweenDoorEnemies = Tabs.Halloween:AddToggle("AutoDefeatDoorEnemies", {
    Title = "Auto Defeat Door Enemies",
    Description = "",
    Default = false
})
